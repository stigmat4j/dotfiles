...
# if [[ vol = 0% ]]; then
#   echo "<span background=\"#021215\" foreground=\"#ffffff\">    mute </span>"
# else
#   echo "<span background=\"#021215\" foreground=\"#3498db\">    $vol </span>"
# fi
...
function print_format {
    ...
    case "$1" in
        ...
        3) echo "<span background=\"#021215\" foreground=\"#ffffff\"> $SYMBOL$VOL$PERCENT </span>" ;;
        *) echo "<span background=\"#021215\" foreground=\"#ffffff\"> $SYMBOL$VOL$PERCENT </span>" ;;
    esac
}
